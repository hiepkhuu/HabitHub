...
class RewardForm(FlaskForm):
    ...
    reward_points = IntegerField('reward_points', validators=[DataRequired('POINTS: Enter how much points this reward is worth.'), NumberRange(min=66, message='POINTS: Must be greater than 66! It takes around 66days for a task to become a habit! ')])
