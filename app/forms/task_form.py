...
class TaskForm(FlaskForm):
    ...
    task_name = StringField('task_name', validators=[DataRequired('Task needs a name'), Length(max=32, message='Name must be fewer than 90 characters!') ])
    task_detail = StringField('task_detail', validators=[Length(max=32, message='Details must be fewer than 32 characters!') ])
