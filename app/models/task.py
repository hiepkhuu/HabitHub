...
class Task(db.Model):
    ...
    task_detail = db.Column(db.String(32), nullable=False)
    task_reason= db.Column(db.String(32), nullable=True)
    ...
    logs = db.relationship('Log', back_populates='task', cascade="all, delete, delete-orphan", lazy=True)
