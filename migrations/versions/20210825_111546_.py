...
Revision ID: 7ca65091b6e3
Revises: 
Create Date: 2021-08-25 11:15:46.663909
...
def upgrade():
    ...
    sa.Column('dy_wk', sa.String(), nullable=True),
    ...
    sa.Column('reward_details', sa.String(length=255), nullable=True),
